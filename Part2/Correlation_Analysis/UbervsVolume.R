#Uber data vs Taxi Volume Data Comparison in time domain
...
result2<-c()
result2[1]=cor(as.numeric(uber2014$V2), as.numeric(uber2014$green_cab), method = c("pearson"))
result2[2]=cor(as.numeric(uber2014$V2), as.numeric(uber2014$yellow_cab), method = c("pearson"))
result2[3]=cor(as.numeric(uber2015_$V2), as.numeric(uber2015_$green_cab), method = c("pearson"))
result2[4]=cor(as.numeric(uber2015_$V2), as.numeric(uber2015_$yellow_cab), method = c("pearson"))

write.csv(result2,'uberVsVolume.csv')
